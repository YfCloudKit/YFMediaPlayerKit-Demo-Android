...
public abstract class BasePlayerDemo extends AppCompatActivity {
    ...
    protected boolean currentDecodeMode = MainActivity.DECODE_MODE <= 1;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_stop_record:
                stopRecord();
                break;
            case R.id.action_start_record_gif:
                startRecordGif();
                break;
            case R.id.action_stop_record_gif:
                stopRecordGif();
                break;
        }
...
//        mYfp2p.JCloseChannel();
    ...
    public abstract void startRecordGif();

    public abstract void stopRecordGif();
